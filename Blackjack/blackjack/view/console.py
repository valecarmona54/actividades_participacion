...
class UIConsola:
    ...
    def ejecutar_turno_de_la_casa(self):
        ...
        valor_mano_casa = self.blackjack.cupier.mano.calcular_valor()
        valor_mano_jugador = self.blackjack.jugador.mano.calcular_valor()

        print ("\n El valor de la mano de la casa es: ", valor_mano_casa)
        print ("\n El valor de la mano del jugador es: ", valor_mano_jugador)
       
        if valor_mano_casa >21:
